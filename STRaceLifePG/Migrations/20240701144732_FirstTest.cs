    ...
    public partial class FirstTest : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubLikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClubLikes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClubLikes_Clubs_ClubId",
                        column: x => x.ClubId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubLikes_ClubId_UserId",
                table: "ClubLikes",
                columns: new[] { "ClubId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClubLikes_UserId",
                table: "ClubLikes",
                column: "UserId");
